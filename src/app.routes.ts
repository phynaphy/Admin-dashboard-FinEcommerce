...
//                 loadComponent: () => import('./app/pages/product-create/product-create.component').then(m => m.ProductCreateComponent)
//             },
//         ]
//     },
...
export const appRoutes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            // 1. Static route MUST come before parametric route
            {
                path: 'admin/products/new',
                loadComponent: () => import('./app/pages/product-create/product-create.component').then(m => m.ProductCreateComponent)
            },
            ...
            // 3. Dynamic ID route MUST come last
            {
                path: 'admin/products/:id',
                loadComponent: () => import('./app/pages/product-detail/product-detail.component').then(m => m.ProductDetailComponent)
            }
